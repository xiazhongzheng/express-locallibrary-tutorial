...
function createBookInstances(cb) {
  async.parallel([
    callback => bookInstanceCreate(
      books[0], '中华书局 2014年版', false, 'Available', callback
    ),
    callback => bookInstanceCreate(
      books[1], '人民文学出版社 汉日对照 2017年版', false, 'Loaned', callback
    ),
    callback => bookInstanceCreate(
      books[1], '人民文学出版社 汉法对照 2017年版', false, 'Available', callback
    ),
    callback => bookInstanceCreate(
      books[2], '海南出版社 2017年版', false, false, callback
    ),
    callback => bookInstanceCreate(
      books[2], '海南出版社 2017年版', false, 'Maintenance', callback
    ),
    callback => bookInstanceCreate(
      books[2], '海南出版社 2017年版', false, 'Available', callback
    ),
    callback => bookInstanceCreate(
      books[3], '中国友谊出版公司 2018版', false, 'Loaned', callback
    ),
    callback => bookInstanceCreate(
      books[3], '现代出版社 2018版', false, 'Maintenance', callback
    ),
    callback => bookInstanceCreate(
      books[4], '浙江文艺出版社 2017版', false, 'Available', callback
    ),
    callback => bookInstanceCreate(
      books[4], '浙江文艺出版社 2017版', false, 'Available', callback
    ),
    ...
    callback => bookInstanceCreate(
      books[5], 'Harper Voyager, 2016.', false, 'Available', callback
    ),
    callback => bookInstanceCreate(
      books[5], 'Harper Voyager, 2016.', false, 'Maintenance', callback
    ),
    callback => bookInstanceCreate(
      books[5], 'Harper Voyager, 2016.', false, 'Loaned', callback
    )
  ], cb); // 可选回调
}
